...
const MapScreen = ({route}) => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      if(route.params?.setCurrentScreen){
        setCurrentScreen(route.params.setCurrentScreen);
      }
      console.log('Current Screen:', route.params?.setCurrentScreen);
    }, [route.params?.setCurrentScreen])
  );
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles1.directionsButton}>
          <Image source={require('../assets/arrow.png')} style={styles1.buttonImage} />
